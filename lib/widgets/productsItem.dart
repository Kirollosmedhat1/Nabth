...
import 'package:application5/pages/agriMarket/product_details%202.dart';
    ...
    return InkWell(
      onTap: () {
        Get.to(ProductDetails(
          img: img,
          name:
              name.isNotEmpty ? name : null, // تمرير null إذا كان الاسم فارغاً
          price: price.isNotEmpty
              ? price
              : null, // تمرير null إذا كان السعر فارغاً
        ));
      },
      child: Container(
